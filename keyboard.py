...
welcome_text = (
    "👋 Приветствуем вас в чате вступления в закрытый канал Потяева Владимира о стоматологии.\n"
    "Вас ждут еженедельные разборы и консультаций, "
    "ортодонтических случаев и комплексных случаев, "
    "интересных ортопедических случаев, разборы организации  клиники и взаимосвязи управления с медициной, "
    "обсуждения, видео и посты по живым вопросам стоматологической отрасли!\n\n"
